...
|------------------|-----------------|-------------------------------------------------------|-----------------|--------------------------------------------------------------------------------------------------------------------------------------|
| Get audit logs   | GET /audit-logs | Optional: `entityType`, `entityId`, `action`, `actor`, `page`, `pageSize` | 200 OK          | `[ { "id": 1, "action": "CREATE", "entityType": "TICKET", "entityId": "5", "performedBy": 2, "actor": "USER", "oldValue": null, "newValue": "...", "timestamp": "2026-03-01T10:00:00Z" } ]` |
...
- Layered architecture completed under `com.att.tdp.issueflow` with `controller`, `service`, `repository`, `dto`, `security`, `exception`, `scheduler`, `audit`, `config`, and `mapper`.
- JWT authentication implemented with login/logout/me and denylist token invalidation.
